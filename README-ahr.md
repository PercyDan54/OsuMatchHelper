...
```text
> git clone https://github.com/PercyDan54/OsuMatchHelper
> npm install
```
...
MainMenu Commands
  ...
  [enter <LobbyID>]   Enter the lobby. e.g. 'enter 123456'
...
Typing `make` without any arguments when MatchHelper is enabled will create a lobby with the tournament lobby name format.
